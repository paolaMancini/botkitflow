...
module.exports = function (controller) {
    ...
    controller.hears([/provide/], 'direct_message,direct_mention', function (bot, message) {
        ...
        text += "\n- " + bot.appendMention(message, "last minute") + ": ask to upload the chart about the pieces done in the last minute";
        text += "\n- " + bot.appendMention(message, "time cicle") + ": ask to upload the chart about the pieces done in the last time cicle";
