            ...
            if (plantName === '1') {
                ...
                request(url, function(error, response, body) {
                        ...
                        bot.startConversation(message, function(err, convo) {
                                ...
                                var help = "Which line are you interested of? Please, type: ";
                                help += "\n- " + bot.appendMention(message, "**line 'line name'**");
                                help += "\n- " + bot.appendMention(message, "Choose line name among:**" + patternAliases + "**");
                                help += "\n- " + bot.appendMention(message, ** " + patternAliases + " ** ");  
